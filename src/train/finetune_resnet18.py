...
def load_data(
    data_dir: str, train_samples: int | None = None, eval_samples: int | None = None
    ...
    def read_parquet_files(
        files: list[str], max_samples: int | None = None
...
def main() -> None:
    ...
    raw_train, raw_eval = load_data(
        args.data_dir, train_samples=args.train_samples, eval_samples=args.eval_samples
    )
